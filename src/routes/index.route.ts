...
import bidHistory from '../routes/bidHistory.route';
...
router.use(BASE_API_ROUTES.TEAMS,teamRoutes);
router.use(BASE_API_ROUTES.ADMIN,adminRoutes);
router.use(BASE_API_ROUTES.BID_HISTORY,bidHistory);
